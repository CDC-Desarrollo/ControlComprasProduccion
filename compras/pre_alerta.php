        ...
        <div class="card border-success p-3 mb-5 bg-white ">
          ...
          <div class="card-body">
            <form id="form1" action="php/pre_alert.php" method="post" class="needs-validation" novalidate>
              ...
              <div class="form-row">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <div class="form-check">
                    <br>
                    <input type="checkbox" class="form-check-input" id="exampleCheck1" name="exampleCheck1"  onchange="calcularPorcentajeSeguro()">
                    <label class="form-check-label" for="exampleCheck1">¿Desea incluir Seguro?</label>
              ...
              <input type="hidden" id="txtIdUsuarioPrealerta" name="txtIdUsuarioPrealerta" value="<?php echo $id_usuario_prealerta ?>">
