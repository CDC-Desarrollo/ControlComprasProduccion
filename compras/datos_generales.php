    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card border-success p-3 mb-5 bg-white ">
          ...
          <div class="card-body">
            <form id="form1" action="php/general_data.php" method="post" class="needs-validation" novalidate>
              ...
              <div class="form-row">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="text" class="form-control" id="txtTelefono" name="txtTelefono"
                    placeholder="+52 (867) 306 7845" value="" required>
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="text" class="form-control" id="txtTelefonoAuxiliar" name="txtTelefonoAuxiliar"
                    placeholder="+52 (867) 124 8752" value="" required>
              ...
              <div class="form-row">
                ...
                <div class="col-md-3 mb-3">
                  ...
                  <input type="text" class="form-control" id="txtCalle" name="txtCalle" placeholder="Guerrero" value=""
                    required>
                ...
                <div class="col-md-3 mb-3">
                  ...
                  <input type="text" class="form-control" id="txtColonia" name="txtColonia" placeholder="Centro"
                    value="" required>
                ...
                <div class="col-md-3 mb-3">
                  ...
                  <input type="text" class="form-control" id="txtNumExterior" name="txtNumExterior" placeholder="1107"
                    value="" required>
              ...
              <div class="form-row">
                ...
                <div class="col-md-2 mb-3">
                  ...
                  <input type="text" class="form-control" id="txtCodigoPostal" name="txtCodigoPostal"
                    placeholder="88000" value="" required>
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" id="txtReferencias" name="txtReferencias" rows="2"
                  placeholder="Plaza Hidalgo a 2 cuadras."
                  required></textarea>
